-- BSCPE class sections for block enlistment (all calendar terms)
-- Run AFTER academic_terms calendar and BSCPE active curriculum exist.
-- Mirrors registrar/db/demo_scripts/01_seed_bsit_class_sections_demo.sql for BSCPE.
