...
| File | What It Is |
|------|-----------|
| `HANDOFF_INDEX.md` | Master index of the `docs/handoff/legacy-capss/` directory tree in the full project |
...
- The full SQL database dumps / demo scripts — see `db/capss-demo-required/` and `docs/handoff/legacy-capss/04-database/`
