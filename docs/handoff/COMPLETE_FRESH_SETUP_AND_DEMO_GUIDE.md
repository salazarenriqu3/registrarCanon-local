...
│   │
│   ├── docs/handoff\                     ★ DEMO / UAT DOCS (this file lives here)
...
| Path | Why |
|------|-----|
| `db\sql_manual\` | One-off patches; bootstrap replaces most |
| `setup\fees\import\` | Legacy CSVs → use `registrar\setup\fees\` |
| `docs/handoff\MASTER_HANDOFF.md`, `NEXT_AGENT_*` | Historical agent notes |
...
Read and follow:
  ...
  registrar/docs/handoff/COMPLETE_FRESH_SETUP_AND_DEMO_GUIDE.md
...
Demo docs after setup:
  registrar/docs/handoff/HUMAN_UAT_CHECKLIST.md
  registrar/docs/handoff/THREE_TRACK_LIFECYCLE_DEMO_MANUAL.md
