...
| 12 | `db/sql_manual/11_bootstrap_materialize_active_term_fees.sql` | Term 1 S2 fallbacks + global copy → active term 2 |
| 14 | `db/sql_manual/02_verify_readiness.sql` | Readiness probes |
