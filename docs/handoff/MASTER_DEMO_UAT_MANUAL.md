...
|------|---------------|
| 1 | `registrar/db/fix` |
| 2 | `registrar/db/sql_manual/01_calendar_and_active_term.sql` |
| 3 | `registrar/db/sql_manual/06_retire_empty_programs.sql` |
...
Verify after each manual step: open `registrar/db/sql_manual/02_verify_readiness.sql` in Workbench → Execute.
...
| 11 | `registrar/db/sql_manual/01_calendar_and_active_term.sql` |
| 12 | `registrar/db/sql_manual/11_bootstrap_materialize_active_term_fees.sql` |
| 13 | `registrar/db/sql_manual/02_verify_readiness.sql` |
...
Fee CSV template: `registrar/setup/fees/import/`
...
| Item | Value |
|------|-------|
| Latest fixes log | `registrar/docs/handoff/HANDOFF_UPDATES_20260609.md` |
| This manual | `registrar/docs/handoff/MASTER_DEMO_UAT_MANUAL.md` |
...
| Human UAT checklist | `registrar/docs/handoff/HUMAN_UAT_CHECKLIST.md` |
