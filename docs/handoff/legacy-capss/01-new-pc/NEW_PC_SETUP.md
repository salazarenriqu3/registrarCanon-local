...
| `registrar/` | Registrar source, `docs/handoff/legacy-capss/`, `db/fix`, all demo SQL |
...
All under `registrar/docs/handoff/legacy-capss/` — see **`../README.md`** for the full folder map.
