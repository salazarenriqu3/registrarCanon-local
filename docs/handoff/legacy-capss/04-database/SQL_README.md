...
**New PC quick path:** see `docs/handoff/legacy-capss/01-new-pc/NEW_PC_SETUP.md`

See **`docs/handoff/legacy-capss/05-demo-guides/README_DEMO_SQL.md`** for grade scripts `01`–`08` and Brent/Elon (`2026-0002` / `2026-0004`) variants.
