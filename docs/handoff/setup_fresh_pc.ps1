...
#
# Or read: registrar/docs/handoff/START_HERE_NEW_PC_HANDOFF.md
#          registrar/docs/handoff/HANDOFF_UPDATES_20260609.md
...
Write-Host ""
Write-Host "See: registrar/docs/handoff/START_HERE_NEW_PC_HANDOFF.md" -ForegroundColor Gray
exit 1
