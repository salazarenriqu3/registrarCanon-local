...
> **CAPSS demo SQL** lives in `registrar/db/capss-demo-required/` (grouped by step). This guide lives in `handoff/05-demo-guides/`. Finance/BSN/legacy SQL stays in `db/demo_scripts/`.
