...
The script `01_mega_schema_and_seed.sql` will now **DROP the entire `registrar_db_v2` database first**, recreate it perfectly clean via `COMPLETE_DATABASE_SETUP`, and loop-inject 1,000+ realistic students.

**Execution:**
1. Open MySQL Workbench.
2. Open `01_mega_schema_and_seed.sql`.
