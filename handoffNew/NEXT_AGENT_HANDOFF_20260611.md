...
1. **`handoffNew/PROJECT_STATUS_AND_ROADMAP.md`**
2. **`handoffNew/HANDOFF_UPDATES_20260609.md`** — §16–§21
3. **`handoffNew/HUMAN_UAT_CHECKLIST.md`** — RET-CURR + Sessions C–F
...
| Registrar Spring Security | `handoffNew/PROPOSAL_REGISTRAR_SPRING_SECURITY.md` |
| Full Sessions C–F sign-off | `HUMAN_UAT_CHECKLIST.md` |
| Handoff doc sync to `C:\Users\sune\Downloads\new\registrar\handoffNew` | Manual if roots diverge |
