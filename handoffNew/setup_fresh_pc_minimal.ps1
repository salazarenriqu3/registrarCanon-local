...
Run-SqlFile "registrar\handoffNew\sql_manual\01_calendar_and_active_term.sql"
Run-SqlFile "registrar\handoffNew\sql_manual\06_retire_empty_programs.sql"
...
Write-Host 'Manual: registrar/handoffNew/MASTER_DEMO_UAT_MANUAL.md'
