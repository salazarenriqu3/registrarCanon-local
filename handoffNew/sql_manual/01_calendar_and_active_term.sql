-- Manual configuration: academic calendar + active term
-- Batch alternative: same content inside setup_fresh_pc.ps1 step 3 + activate
USE eacdb;
...
VALUES
    ...
    ('2120242025', 'A.Y. 2024-2025 - 2nd Semester', '2024-2025', 2, '2025-01-15', '2025-05-30', 'ACTIVE', 1),
...
SELECT term_id, term_code, is_active, status FROM academic_terms ORDER BY term_code;
